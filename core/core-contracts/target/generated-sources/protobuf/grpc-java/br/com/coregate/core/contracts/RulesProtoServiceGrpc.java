...
@javax.annotation.Generated(
    ...
    comments = "Source: transaction-rules.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class RulesProtoServiceGrpc {

  private RulesProtoServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "br.com.coregate.core.contracts.RulesProtoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<br.com.coregate.core.contracts.RulesRequestProto,
      br.com.coregate.core.contracts.RulesResponseProto> getEvaluateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Evaluate",
      requestType = br.com.coregate.core.contracts.RulesRequestProto.class,
      responseType = br.com.coregate.core.contracts.RulesResponseProto.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.com.coregate.core.contracts.RulesRequestProto,
      br.com.coregate.core.contracts.RulesResponseProto> getEvaluateMethod() {
    io.grpc.MethodDescriptor<br.com.coregate.core.contracts.RulesRequestProto, br.com.coregate.core.contracts.RulesResponseProto> getEvaluateMethod;
      ...
      synchronized (RulesProtoServiceGrpc.class) {
        if ((getEvaluateMethod = RulesProtoServiceGrpc.getEvaluateMethod) == null) {
          RulesProtoServiceGrpc.getEvaluateMethod = getEvaluateMethod =
              io.grpc.MethodDescriptor.<br.com.coregate.core.contracts.RulesRequestProto, br.com.coregate.core.contracts.RulesResponseProto>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Evaluate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.coregate.core.contracts.RulesRequestProto.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.coregate.core.contracts.RulesResponseProto.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void evaluate(br.com.coregate.core.contracts.RulesRequestProto request,
        io.grpc.stub.StreamObserver<br.com.coregate.core.contracts.RulesResponseProto> responseObserver) {
  ...
  public static final class RulesProtoServiceStub
    ...
    /**
     */
    public void evaluate(br.com.coregate.core.contracts.RulesRequestProto request,
        io.grpc.stub.StreamObserver<br.com.coregate.core.contracts.RulesResponseProto> responseObserver) {
  ...
  public static final class RulesProtoServiceBlockingStub
    ...
    /**
     */
    public br.com.coregate.core.contracts.RulesResponseProto evaluate(br.com.coregate.core.contracts.RulesRequestProto request) {
  ...
  public static final class RulesProtoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.com.coregate.core.contracts.RulesResponseProto> evaluate(
        br.com.coregate.core.contracts.RulesRequestProto request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EVALUATE:
          serviceImpl.evaluate((br.com.coregate.core.contracts.RulesRequestProto) request,
              (io.grpc.stub.StreamObserver<br.com.coregate.core.contracts.RulesResponseProto>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              br.com.coregate.core.contracts.RulesRequestProto,
              br.com.coregate.core.contracts.RulesResponseProto>(
  ...
  private static abstract class RulesProtoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.com.coregate.core.contracts.RulesProto.getDescriptor();
    }
