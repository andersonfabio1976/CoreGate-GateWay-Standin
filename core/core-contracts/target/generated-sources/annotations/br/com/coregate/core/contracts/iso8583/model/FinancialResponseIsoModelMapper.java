...
public class FinancialResponseIsoModelMapper {

    public static FinancialResponseIsoModel decode(String iso) {
        FinancialResponseIsoModel model = new FinancialResponseIsoModel();
        int offset = 0;
    ...
    public static String encode(FinancialResponseIsoModel model) {
