...
public class AuthorizationRequestIsoModelMapper {

    public static AuthorizationRequestIsoModel decode(String iso) {
        AuthorizationRequestIsoModel model = new AuthorizationRequestIsoModel();
        int offset = 0;
    ...
    public static String encode(AuthorizationRequestIsoModel model) {
