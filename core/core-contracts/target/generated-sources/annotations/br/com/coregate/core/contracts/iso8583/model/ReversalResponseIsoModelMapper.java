...
public class ReversalResponseIsoModelMapper {

    public static ReversalResponseIsoModel decode(String iso) {
        ReversalResponseIsoModel model = new ReversalResponseIsoModel();
        int offset = 0;
    ...
    public static String encode(ReversalResponseIsoModel model) {
