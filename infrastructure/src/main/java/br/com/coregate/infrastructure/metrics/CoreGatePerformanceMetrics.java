...
public class CoreGatePerformanceMetrics {
    ...
    // ===========================================================
    public static void recordRollbackStatic(String tenant, String type, String mode, int steps, long elapsedMs) {
    ...
    public static void recordStepStatic(String tenant, String mode, String step, long elapsedMs, boolean success) {
        if (staticRegistry == null) return;
        new CoreGatePerformanceMetrics(staticRegistry)
